...
public class UsuarioService {
    ...
    public List<UsuarioResponse> listarActivos(Long usuarioAutenticadoId) {
        Long empresaId = buscarActivo(usuarioAutenticadoId).getEmpresa().getId();
    ...
    public UsuarioResponse registrar(
        ...
        Usuario usuarioAutenticado = buscarActivo(usuarioAutenticadoId);
        exigirAdministrador(usuarioAutenticado.getRolAcceso());
    ...
    public UsuarioResponse cambiarRol(
        ...
        Usuario usuarioAutenticado = buscarActivo(usuarioAutenticadoId);
        exigirAdministrador(usuarioAutenticado.getRolAcceso());
        Usuario usuario = buscarUsuarioActivo(usuarioAutenticado.getEmpresa().getId(), usuarioId);
